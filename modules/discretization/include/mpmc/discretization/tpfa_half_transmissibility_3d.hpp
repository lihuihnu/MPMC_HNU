#ifndef MPMC_DISCRETIZATION_TPFA_HALF_TRANSMISSIBILITY_3D_HPP
#define MPMC_DISCRETIZATION_TPFA_HALF_TRANSMISSIBILITY_3D_HPP
...
inline void validate_half_connection(
    ...
    if (!std::isfinite(
        ...
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: invalid half-connection coefficient");
    }
    ...
    case TpfaHalfConnectionProjection3D::
        ...
        if (half_connection
            ...
            half_connection.coefficient_m <= 0.0) {
            throw std::invalid_argument(
                "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: positive projection requires positive numerator and coefficient");
        }
        break;
    case TpfaHalfConnectionProjection3D::
        zero_projection:
        if (half_connection
            ...
            half_connection.coefficient_m != 0.0) {
            throw std::invalid_argument(
                "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: zero projection requires exact zero numerator and coefficient");
        }
        break;
    default:
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: invalid projection state");
    }
    ...
    if (!std::isfinite(
        ...
        std::abs(
            ...
            tolerance_m) {
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: half-connection numerator/denominator/coefficient are inconsistent");
    }
}
...
make_area_scaled_tpfa_half_transmissibility_3d(
    ...
    if (!std::isfinite(face_area_m2) ||
        face_area_m2 <= 0.0) {
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: face area must be finite and strictly positive");
    }
    ...
    if (!std::isfinite(
        ...
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: area-scaled half transmissibility must be finite and non-negative");
    }
    ...
    if (half_connection.projection ==
        ...
        throw std::logic_error(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: zero projection did not remain zero after area scaling");
    }
    if (half_connection.projection ==
            TpfaHalfConnectionProjection3D::
                positive_projection &&
        half_transmissibility_m3 <= 0.0) {
        throw std::invalid_argument(
            "mpmc::discretization::make_area_scaled_tpfa_half_transmissibility_3d: positive projection must produce positive area-scaled half transmissibility");
    }
...
#endif // MPMC_DISCRETIZATION_TPFA_HALF_TRANSMISSIBILITY_3D_HPP
