#ifndef MPMC_MESH_TPFA_STATIC_FACE_TRANSMISSIBILITY_3D_HPP
#define MPMC_MESH_TPFA_STATIC_FACE_TRANSMISSIBILITY_3D_HPP
...
inline void validate_area_scaled_half(
    ...
    if (!std::isfinite(half.face_area_m2) ||
        ...
        throw std::invalid_argument(
            "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: half area/transmissibility must be finite with positive area and non-negative transmissibility");
    }
    ...
    if (!std::isfinite(reconstructed_m3)) {
        throw std::invalid_argument(
            "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: reconstructed half transmissibility is non-finite");
    }
    ...
    if (std::abs(
        ...
        tolerance_m3) {
        throw std::invalid_argument(
            "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: area/coefficient/transmissibility are inconsistent");
    }
    ...
    case TpfaHalfConnectionProjection3D::
        ...
        if (half.half_transmissibility_m3 <=
            0.0) {
            throw std::invalid_argument(
                "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: positive projection requires positive half transmissibility");
        }
        break;
    case TpfaHalfConnectionProjection3D::
        zero_projection:
        if (half.half_transmissibility_m3 !=
            0.0) {
            throw std::invalid_argument(
                "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: zero projection requires exact zero half transmissibility");
        }
        break;
    default:
        throw std::invalid_argument(
            "mpmc::mesh::combine_internal_face_tpfa_half_transmissibilities_3d: invalid half projection state");
    }
}
...
make_internal_face_static_tpfa_transmissibility_3d(
    ...
    if (!geometry.face_neighbour(face).has_value()) {
        throw std::invalid_argument(
            "mpmc::mesh::make_internal_face_static_tpfa_transmissibility_3d: internal face is required");
    }
...
#endif // MPMC_MESH_TPFA_STATIC_FACE_TRANSMISSIBILITY_3D_HPP
