...
- [S7] Kenyon, D. E.; Behie, G. A. (1987). *Third SPE Comparative Solution Project: Gas Cycling of Retrograde Condensate Reservoirs*. Journal of Petroleum Technology 39(8), 981–997. DOI: [10.2118/12278-PA](https://doi.org/10.2118/12278-PA)。当前仅将其 table-2 saturation/relative-permeability/capillary data 用作 flow constitutive 的 reference-backed regression；公开机器可读副本固定为 `OPM/opm-data@b65b5209d9135e66592fce07d00bf6f8d6d1a651:spe3/SPE3CASE2.DATA`，不据此引入新的 production constitutive model。
